...
export interface Database {
  public: {
    Tables: {
      ...
      fincas: {
        Row: { id: string; nombre: string; municipio: string | null; departamento: string | null; hectareas: number | null; area_valor: number | null; area_unidad: string | null; tipo_produccion: string[] | null; etapas_cerdos: string[] | null; propietario_id: string | null; altitud_msnm: number | null; velocidad_viento_kmh: number | null; clima_predominante: string | null; temperatura_promedio_ext: number | null; latitud: number | null; longitud: number | null; precio_huevo_b: number | null; precio_huevo_a: number | null; precio_huevo_aa: number | null; precio_huevo_aaa: number | null; precio_huevo_jumbo: number | null; created_at: string }
        Insert: { id?: string; nombre: string; municipio?: string | null; departamento?: string | null; hectareas?: number | null; area_valor?: number | null; area_unidad?: string | null; tipo_produccion?: string[] | null; etapas_cerdos?: string[] | null; propietario_id?: string | null; altitud_msnm?: number | null; velocidad_viento_kmh?: number | null; clima_predominante?: string | null; temperatura_promedio_ext?: number | null; latitud?: number | null; longitud?: number | null; precio_huevo_b?: number | null; precio_huevo_a?: number | null; precio_huevo_aa?: number | null; precio_huevo_aaa?: number | null; precio_huevo_jumbo?: number | null; created_at?: string }
        Update: { id?: string; nombre?: string; municipio?: string | null; departamento?: string | null; hectareas?: number | null; area_valor?: number | null; area_unidad?: string | null; tipo_produccion?: string[] | null; etapas_cerdos?: string[] | null; propietario_id?: string | null; altitud_msnm?: number | null; velocidad_viento_kmh?: number | null; clima_predominante?: string | null; temperatura_promedio_ext?: number | null; latitud?: number | null; longitud?: number | null; precio_huevo_b?: number | null; precio_huevo_a?: number | null; precio_huevo_aa?: number | null; precio_huevo_aaa?: number | null; precio_huevo_jumbo?: number | null; created_at?: string }
        Relationships: []
      }
      ...
      entradas_alimento_aves: {
        Row: { id: string; finca_id: string; lote_id: string | null; tipo_alimento_id: string; fecha: string; cantidad_bultos: number; precio_bulto: number | null; proveedor: string | null; observaciones: string | null; fecha_vencimiento: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; finca_id: string; lote_id?: string | null; tipo_alimento_id: string; fecha?: string; cantidad_bultos: number; precio_bulto?: number | null; proveedor?: string | null; observaciones?: string | null; fecha_vencimiento?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; finca_id?: string; lote_id?: string | null; tipo_alimento_id?: string; fecha?: string; cantidad_bultos?: number; precio_bulto?: number | null; proveedor?: string | null; observaciones?: string | null; fecha_vencimiento?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      ...
      pagos_ventas_huevos: {
        Row: { id: string; venta_id: string; finca_id: string; fecha: string; titular: string | null; monto: number; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; venta_id: string; finca_id: string; fecha?: string; titular?: string | null; monto: number; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; venta_id?: string; finca_id?: string; fecha?: string; titular?: string | null; monto?: number; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      ventas_huevos_aves: {
      ...
      reproductoras_cerdos: {
        Row: { id: string; lote_id: string; finca_id: string; codigo: string; nombre: string | null; linea_genetica: string | null; fecha_nacimiento: string | null; fecha_ingreso: string; numero_partos: number; estado: string; peso_kg: number | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; lote_id: string; finca_id: string; codigo: string; nombre?: string | null; linea_genetica?: string | null; fecha_nacimiento?: string | null; fecha_ingreso?: string; numero_partos?: number; estado?: string; peso_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; lote_id?: string; finca_id?: string; codigo?: string; nombre?: string | null; linea_genetica?: string | null; fecha_nacimiento?: string | null; fecha_ingreso?: string; numero_partos?: number; estado?: string; peso_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      inseminaciones_cerdos: {
        Row: { id: string; servicio_id: string; finca_id: string; fecha: string; hora: string | null; codigo_semen: string | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; servicio_id: string; finca_id: string; fecha?: string; hora?: string | null; codigo_semen?: string | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; servicio_id?: string; finca_id?: string; fecha?: string; hora?: string | null; codigo_semen?: string | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      servicios_cerdos: {
        Row: { id: string; reproductora_id: string; lote_id: string; finca_id: string; fecha_servicio: string; tipo: string; verraco: string | null; codigo_semen: string | null; numero_dosis: number | null; fecha_probable_parto: string | null; prenez_confirmada: boolean; fecha_confirmacion: string | null; estado: string; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; reproductora_id: string; lote_id: string; finca_id: string; fecha_servicio?: string; tipo?: string; verraco?: string | null; codigo_semen?: string | null; numero_dosis?: number | null; fecha_probable_parto?: string | null; prenez_confirmada?: boolean; fecha_confirmacion?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; reproductora_id?: string; lote_id?: string; finca_id?: string; fecha_servicio?: string; tipo?: string; verraco?: string | null; codigo_semen?: string | null; numero_dosis?: number | null; fecha_probable_parto?: string | null; prenez_confirmada?: boolean; fecha_confirmacion?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      partos_cerdos: {
        Row: { id: string; servicio_id: string | null; reproductora_id: string; lote_id: string; finca_id: string; fecha_parto: string; nacidos_vivos: number; nacidos_muertos: number; momificados: number; muertos_postparto: number; pesos_nacimiento_kg: number[] | null; peso_camada_kg: number | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; servicio_id?: string | null; reproductora_id: string; lote_id: string; finca_id: string; fecha_parto?: string; nacidos_vivos?: number; nacidos_muertos?: number; momificados?: number; muertos_postparto?: number; pesos_nacimiento_kg?: number[] | null; peso_camada_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; servicio_id?: string | null; reproductora_id?: string; lote_id?: string; finca_id?: string; fecha_parto?: string; nacidos_vivos?: number; nacidos_muertos?: number; momificados?: number; muertos_postparto?: number; pesos_nacimiento_kg?: number[] | null; peso_camada_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      destetes_cerdos: {
        Row: { id: string; parto_id: string | null; reproductora_id: string; lote_id: string; finca_id: string; fecha_destete: string; lechones_destetados: number; peso_promedio_kg: number | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; parto_id?: string | null; reproductora_id: string; lote_id: string; finca_id: string; fecha_destete?: string; lechones_destetados?: number; peso_promedio_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; parto_id?: string | null; reproductora_id?: string; lote_id?: string; finca_id?: string; fecha_destete?: string; lechones_destetados?: number; peso_promedio_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      etapas_cerdos: {
