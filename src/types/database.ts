...
export interface Database {
  public: {
    Tables: {
      ...
      costos_lote_aves: {
        Row: { id: string; lote_id: string; finca_id: string; fecha: string; categoria: string; descripcion: string; monto: number; proveedor: string | null; observaciones: string | null; equipo_id: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; lote_id: string; finca_id: string; fecha?: string; categoria: string; descripcion: string; monto: number; proveedor?: string | null; observaciones?: string | null; equipo_id?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; lote_id?: string; finca_id?: string; fecha?: string; categoria?: string; descripcion?: string; monto?: number; proveedor?: string | null; observaciones?: string | null; equipo_id?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      equipos_aves: {
