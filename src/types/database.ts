...
export interface Database {
  public: {
    Tables: {
      ...
      fincas: {
        Row: { id: string; nombre: string; municipio: string | null; departamento: string | null; hectareas: number | null; tipo_produccion: string[] | null; propietario_id: string | null; created_at: string }
        Insert: { id?: string; nombre: string; municipio?: string | null; departamento?: string | null; hectareas?: number | null; tipo_produccion?: string[] | null; propietario_id?: string | null; created_at?: string }
        Update: { id?: string; nombre?: string; municipio?: string | null; departamento?: string | null; hectareas?: number | null; tipo_produccion?: string[] | null; propietario_id?: string | null; created_at?: string }
        Relationships: []
      }
      finca_miembros: {
      ...
      // ── Aves Ponedoras ────────────────────────────────────────────────
      lotes_aves: {
        Row: { id: string; finca_id: string; nombre: string; linea_genetica: string | null; fecha_inicio: string; fecha_fin: string | null; aves_iniciales: number; aves_actuales: number; origen_aves: string | null; estado: string; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; finca_id: string; nombre: string; linea_genetica?: string | null; fecha_inicio?: string; fecha_fin?: string | null; aves_iniciales?: number; aves_actuales?: number; origen_aves?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; finca_id?: string; nombre?: string; linea_genetica?: string | null; fecha_inicio?: string; fecha_fin?: string | null; aves_iniciales?: number; aves_actuales?: number; origen_aves?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      ...
      eventos_clinicos_aves: {
        Row: { id: string; lote_id: string; finca_id: string; fecha: string; tipo_evento: string; descripcion: string; aves_afectadas: number | null; aves_muertas: number | null; accion_tomada: string | null; veterinario: string | null; resuelto: boolean; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; lote_id: string; finca_id: string; fecha?: string; tipo_evento: string; descripcion: string; aves_afectadas?: number | null; aves_muertas?: number | null; accion_tomada?: string | null; veterinario?: string | null; resuelto?: boolean; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; lote_id?: string; finca_id?: string; fecha?: string; tipo_evento?: string; descripcion?: string; aves_afectadas?: number | null; aves_muertas?: number | null; accion_tomada?: string | null; veterinario?: string | null; resuelto?: boolean; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      costos_lote_aves: {
        Row: { id: string; lote_id: string; finca_id: string; fecha: string; categoria: string; descripcion: string; monto: number; proveedor: string | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; lote_id: string; finca_id: string; fecha?: string; categoria: string; descripcion: string; monto: number; proveedor?: string | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
      ...
      // ── Cerdos ───────────────────────────────────────────────────────
      lotes_cerdos: {
        Row: { id: string; finca_id: string; nombre: string; linea_genetica: string | null; fecha_ingreso: string; etapa_actual: string; numero_animales: number; animales_actuales: number; peso_promedio_inicial: number | null; origen_animales: string | null; corral: string | null; estado: string; observaciones: string | null; registrado_por: string | null; created_at: string }
      ...
      nutricion_diaria_cerdos: {
        Row: { id: string; lote_id: string; finca_id: string; fecha: string; alimento_kg: number; tipo_alimento: string | null; agua_litros: number | null; aditivos: string | null; costo_alimento: number | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; lote_id: string; finca_id: string; fecha?: string; alimento_kg?: number; tipo_alimento?: string | null; agua_litros?: number | null; aditivos?: string | null; costo_alimento?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; lote_id?: string; finca_id?: string; fecha?: string; alimento_kg?: number; tipo_alimento?: string | null; agua_litros?: number | null; aditivos?: string | null; costo_alimento?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      ...
      // ── Pollo de Engorde ─────────────────────────────────────────────
      lotes_pollo: {
        Row: { id: string; finca_id: string; nombre: string; linea_genetica: string | null; fecha_ingreso: string; fecha_salida: string | null; pollos_iniciales: number; pollos_actuales: number; peso_promedio_inicial: number | null; origen_pollos: string | null; galpone: string | null; estado: string; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; finca_id: string; nombre: string; linea_genetica?: string | null; fecha_ingreso?: string; fecha_salida?: string | null; pollos_iniciales?: number; pollos_actuales?: number; peso_promedio_inicial?: number | null; origen_pollos?: string | null; galpone?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; finca_id?: string; nombre?: string; linea_genetica?: string | null; fecha_ingreso?: string; fecha_salida?: string | null; pollos_iniciales?: number; pollos_actuales?: number; peso_promedio_inicial?: number | null; origen_pollos?: string | null; galpone?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      produccion_diaria_pollo: {
        Row: { id: string; lote_id: string; finca_id: string; fecha: string; alimento_kg: number; agua_litros: number | null; muertes: number; causa_muerte: string | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; lote_id: string; finca_id: string; fecha?: string; alimento_kg?: number; agua_litros?: number | null; muertes?: number; causa_muerte?: string | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; lote_id?: string; finca_id?: string; fecha?: string; alimento_kg?: number; agua_litros?: number | null; muertes?: number; causa_muerte?: string | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      pesos_lote_pollo: {
