...
export interface Database {
  public: {
    Tables: {
      ...
      servicios_cerdos: {
        Row: { id: string; reproductora_id: string; lote_id: string; finca_id: string; fecha_servicio: string; tipo: string; verraco: string | null; numero_dosis: number | null; fecha_probable_parto: string | null; prenez_confirmada: boolean; fecha_confirmacion: string | null; estado: string; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; reproductora_id: string; lote_id: string; finca_id: string; fecha_servicio?: string; tipo?: string; verraco?: string | null; numero_dosis?: number | null; fecha_probable_parto?: string | null; prenez_confirmada?: boolean; fecha_confirmacion?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; reproductora_id?: string; lote_id?: string; finca_id?: string; fecha_servicio?: string; tipo?: string; verraco?: string | null; numero_dosis?: number | null; fecha_probable_parto?: string | null; prenez_confirmada?: boolean; fecha_confirmacion?: string | null; estado?: string; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      partos_cerdos: {
        Row: { id: string; servicio_id: string | null; reproductora_id: string; lote_id: string; finca_id: string; fecha_parto: string; nacidos_vivos: number; nacidos_muertos: number; momificados: number; peso_camada_kg: number | null; observaciones: string | null; registrado_por: string | null; created_at: string }
        Insert: { id?: string; servicio_id?: string | null; reproductora_id: string; lote_id: string; finca_id: string; fecha_parto?: string; nacidos_vivos?: number; nacidos_muertos?: number; momificados?: number; peso_camada_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Update: { id?: string; servicio_id?: string | null; reproductora_id?: string; lote_id?: string; finca_id?: string; fecha_parto?: string; nacidos_vivos?: number; nacidos_muertos?: number; momificados?: number; peso_camada_kg?: number | null; observaciones?: string | null; registrado_por?: string | null; created_at?: string }
        Relationships: []
      }
      destetes_cerdos: {
