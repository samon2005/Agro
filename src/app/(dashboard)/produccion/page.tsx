  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {[
          { tipo: 'Leche', icon: 'tetero' as const, unidad: 'Litros hoy', color: 'blue' },
          { tipo: 'Huevos', icon: 'huevo' as const, unidad: 'Unidades hoy', color: 'yellow' },
          { tipo: 'Carne', icon: 'ganado' as const, unidad: 'Kg este mes', color: 'red' },
        ].map(({ tipo, icon, unidad, color }) => (
          <Card key={tipo} className={`border-${color}-200 bg-${color}-50`}>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                <span className="flex size-11 items-center justify-center rounded-full bg-white/70 text-gray-700"><Ic n={icon} className="size-5" /></span>
                <div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <span className="text-5xl mb-4"><Ic n="tendencia" /></span>
